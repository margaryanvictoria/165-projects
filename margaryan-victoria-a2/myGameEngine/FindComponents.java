...
// Import JInput Library to get Controller & Component Information
...
public class FindComponents {
    public void listControllers() {
        ...
        for (int i=0; i < cs.length; i++) {
            temp = cs[i].getType().toString(); //get the controller Type for filtering
            System.out.println("\nController #" + i);
            // If it's a gamepad, print it, otherwise, don't give me the details
            if (temp.equals("Mouse") || temp.equals("Keyboard") || temp.equals("Gamepad")) {
                listComponents(cs[i]);
            } else {    
                System.out.println(" If you want to see the details, edit the if statement on line 21 in \"FindComponents.java\".");
            }
        }
    }
